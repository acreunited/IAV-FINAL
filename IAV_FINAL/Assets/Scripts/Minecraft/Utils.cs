...
public class Utils 
{
    ...
    public static int GenerateHeight(float x,float z)
    {
       ...
       // float smoothaux = smooth[random1];
        ...
        return (int)Map(0, maxHeight, 0, 1, fBM(x* smooth, z* smooth, octavesaux, persistence));
    }
    ...
    public static int GenerateStoneHeight(float x, float z)
    {
       ...
       // float smoothaux = smooth[random];
        int random2 = (int)Random.Range(0, 1);
        int octavesaux = octaves[random2];
        return (int)Map(0, maxHeight-10, 0, 1, fBM(x * 3* smooth, z *3* smooth, octavesaux-1, 1.2f*persistence));
    }
